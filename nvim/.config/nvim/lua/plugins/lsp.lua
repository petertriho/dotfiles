...
local required_servers = {
    ...
    "python", "tailwindcss", "terraform", "typescript", "yaml"
}
...
local efm_config = {
    ...
    filetypes = {
        "css", "dockerfile", "javascript", "javascriptreact", "json", "html",
        "lua", "markdown", "python", "scss", "sh", "typescript",
        "typescriptreact", "yaml"
    },
    settings = {
        rootMarkers = {
            ".git", ".venv", "node_modules", "tsconfig.json", "jsconfig.json",
            "setup.py"
        },
        languages = {
            css = {prettier},
